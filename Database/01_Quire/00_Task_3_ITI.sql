...
--8.[]List the last name of all managers who have no dependents.(WRONG IN THIS QUIRY)
--9.[]For each department-- if its average salary is less than the average salary of all employees
