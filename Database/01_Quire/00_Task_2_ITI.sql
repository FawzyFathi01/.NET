...
select p.Pname,d.Dname , concat (e.Fname,' ' , e.Lname) as EmpName , e.Address,e.Bdate
...
values ('Ashraf','Ali',102672,112233,3000,30);
...
values ('Mohsen','Mohamed', 102660,30);

--3.[✔]Upgrade your salary by 20 % of its for last row 
Update Employee 
set Salary += 400
where SSN =(
SELECT TOP 1 SSN
